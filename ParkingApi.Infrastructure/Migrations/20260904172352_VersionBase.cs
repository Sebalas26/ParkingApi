        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultInitialCash = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false, defaultValue: 0m),
                    AllowChargeByMinute = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCustomPlan = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    MaxBranches = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    MaxUsers = table.Column<int>(type: "int", nullable: false),
                    HasDesktopAccess = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    HasWebAccess = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CustomModulesWebJson = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CustomModulesDesktopJson = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SubscriptionExpiresAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    AllowMultipleSessions = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    MaxActiveSessionsPerUser = table.Column<int>(type: "int", nullable: false),
                    AllowMultipleOpenShifts = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PriceCop = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    AnnualPriceCop = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    ...
                    AllowMultipleSessions = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    MaxActiveSessionsPerUser = table.Column<int>(type: "int", nullable: false),
                    IncludedModulesWebJson = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IncludedModulesDesktopJson = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Jti = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DeviceInfo = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    RevokedReason = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OperatorName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CashRegisterName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false, defaultValue: "Caja Principal")
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Plans_ResponsibleUserIdNavigationId",
                table: "Plans",
                column: "ResponsibleUserIdNavigationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSessions_UserId_IsRevoked_ExpiresAtUtc",
                table: "UserSessions",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Plans_User_ResponsibleUserIdNavigationId",
                table: "Plans",
                column: "ResponsibleUserIdNavigationId",
                principalTable: "User",
                principalColumn: "Id");
