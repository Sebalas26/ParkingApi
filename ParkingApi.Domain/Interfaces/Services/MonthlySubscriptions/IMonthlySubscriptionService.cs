...
{
    Task<IReadOnlyList<MonthlySubscriptionDto>> GetAllAsync(int? companyId = null, int? branchId = null, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<MonthlySubscriptionDto>> GetActiveAsync(int? companyId = null, int? branchId = null, CancellationToken cancellationToken = default);
    Task<MonthlySubscriptionDto?> GetByIdAsync(Guid subscriptionId, CancellationToken cancellationToken = default);
    Task<MonthlySubscriptionDto?> GetActiveByPlateAsync(string plateNumber, int? companyId = null, int? branchId = null, CancellationToken cancellationToken = default);
