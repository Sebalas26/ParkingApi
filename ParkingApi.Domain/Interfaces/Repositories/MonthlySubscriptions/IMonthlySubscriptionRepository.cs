...
{
    Task<IReadOnlyList<MonthlySubscription>> GetAllAsync(int? companyId = null, int? branchId = null, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<MonthlySubscription>> GetActiveAsync(int? companyId = null, int? branchId = null, CancellationToken cancellationToken = default);
    Task<MonthlySubscription?> GetByIdAsync(Guid subscriptionId, CancellationToken cancellationToken = default);
    Task<MonthlySubscription?> GetActiveByPlateAsync(string plateNumber, int? companyId = null, int? branchId = null, CancellationToken cancellationToken = default);
